...
export const errorHandler = (
  ...
  if (err.name === 'PrismaClientKnownRequestError') {
    ...
    if (prismaError.code === 'P2002') {
      error = { name: 'PrismaError', message: 'Duplicate field value', statusCode: 400 } as AppError;
    } else if (prismaError.code === 'P2025') {
      error = { name: 'PrismaError', message: 'Record not found', statusCode: 404 } as AppError;
    }
  }
